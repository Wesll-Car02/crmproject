    ...
    <div className="space-y-6 animate-fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Catálogo, preços e cotações</p>
        </div>
      </div>
      ...
      <div className="glass-card p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-semibold text-dark-100 mb-2">CPQ</h3>
        <p className="text-dark-400 text-sm max-w-sm">
          Este módulo está em desenvolvimento. Em breve você terá acesso completo a todas as funcionalidades de Catálogo, preços e cotações.
        </p>
